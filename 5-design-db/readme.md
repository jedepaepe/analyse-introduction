...
Nous ne parlerons ici que du design de DB relationnelle.

Voir :
- [nodes de l'ancien cours](https://jedepaepe.github.io/analyse-introduction-legacy/AT04-database-model/index.html)
- [exemple de la demande de congé](https://jedepaepe.github.io/analyse-introduction-legacy/E02-ddc/index.html#section-design-database)
