...
Il analyse 
- un métier, un domaine
- un besoin
- une fonctionnalité
- une application

Souvent aussi il teste les applications pour vérifier qu'elles se comportent bien comme décrit dans l'analyse.
...
Il communique. Il communique avec :
